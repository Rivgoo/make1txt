export const en = {
  ...
  settings: {
    ...
    labels: {
      ...
      fileDelimiterFormat: 'Block Separator Style',
      formatMarkdown: 'Markdown Blocks',
      formatClassic: 'Classic Text Separators',
      formatCustom: 'Custom Template',
      outputTemplate: 'File merge template. Variables: {{path}}, {{ext}}, {{content}}',
  ...
  quickSettings: {
    ...
    enableCSharpAnalysis: 'C# Meta Analysis',
