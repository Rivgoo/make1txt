export const uk = {
  ...
  settings: {
    ...
    labels: {
      ...
      fileDelimiterFormat: 'Стиль розділювача файлів',
      formatMarkdown: 'Markdown Блоки',
      formatClassic: 'Класичні текстові розділювачі',
      formatCustom: 'Власний шаблон',
      outputTemplate: 'Шаблон склеювання файлів. Змінні: {{path}}, {{ext}}, {{content}}',
  ...
  quickSettings: {
    ...
    enableCSharpAnalysis: 'C# Мета-аналіз',
  ...
  sync: {
    loadingTitle: 'Синхронізація з IDE...',
    loadingDesc: 'Безпечно отримуємо контекст проєкту через локальний міст.',
    errorTitle: 'Помилка з\'єднання',
    errorDesc: 'Не вдалося отримати дані з IDE. Можливо, сервер вимкнувся або токен невірний.',
    goHome: 'На головну',
    successMessage: 'Робочий простір успішно синхронізовано.'
  }
};